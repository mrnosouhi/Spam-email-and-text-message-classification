...
fig, ax  = plt.subplots(figsize=(7, 12), dpi=100)
ax.barh(columns, forest.feature_importances_)
ax.set_xlabel("Importance of Feature for 5 estimators")
ax.set_ylabel("Feature")
...
plt.figure()
plot_confusion_matrix(cm, class_names,
                          normalize=False, title='Random Forest Confusion matrix for n_estimators=5', cmap=plt.cm.Blues)
plt.show()


forest15 = RandomForestClassifier(n_estimators=15, random_state=2)
forest15.fit(X_train, y_train)
## Plot Random Forest feature importances
fig, ax  = plt.subplots(figsize=(7, 12), dpi=100)
ax.barh(columns, forest15.feature_importances_)
ax.set_xlabel("Importance of Feature for 15 estinators")
ax.set_ylabel("Feature")
ax.set_title("Random Forest Feature Importance")
#plt.show()

# How many correct predictions? Using a confusion matrix we can see how many correct prediction the modal has
y_pred = forest15.predict(X_test)
cm = confusion_matrix(y_test, y_pred)
print("Confusion Matrix:\n", cm)
...
plt.figure()
plot_confusion_matrix(cm, class_names,
                          normalize=False, title='Random Forest Confusion matrix for n_estimators=15', cmap=plt.cm.Blues)
plt.show()



forest25 = RandomForestClassifier(n_estimators=25, random_state=2)
forest25.fit(X_train, y_train)
## Plot Random Forest feature importances
fig, ax  = plt.subplots(figsize=(7, 12), dpi=100)
ax.barh(columns, forest25.feature_importances_)
ax.set_xlabel("Importance of Feature for 25 estimators")
ax.set_ylabel("Feature")
ax.set_title("Random Forest Feature Importance")
#plt.show()

# How many correct predictions? Using a confusion matrix we can see how many correct prediction the modal has
y_pred = forest25.predict(X_test)
cm = confusion_matrix(y_test, y_pred)
print("Confusion Matrix:\n", cm)
...
plt.figure()
plot_confusion_matrix(cm, class_names,
                          normalize=False, title='Random Forest Confusion matrix for n_estimators=25', cmap=plt.cm.Blues)
plt.show()
####################################################
# SVM
...
## Decision Tree
print("")
print("Decision Tree accuracy without max_depth:")
print("Training Set: {:.3f}".format(tree.score(X_train, y_train)))
print("Test Set: {:.3f}".format(tree.score(X_test, y_test)))

print("")
print("Decision Tree accuracy with max_depth=4:")
print("Training Set: {:.3f}".format(tree4.score(X_train, y_train)))
print("Test Set: {:.3f}".format(tree4.score(X_test, y_test)))

## Random Forest
print("")
print("Random Forest accuracy for 5 estinators:")
print("Training Set: {:.3f}".format(forest.score(X_train, y_train)))
print("Test Set: {:.3f}".format(forest.score(X_test, y_test)))

print("")
print("Random Forest accuracy for 15 estinators:")
print("Training Set: {:.3f}".format(forest15.score(X_train, y_train)))
print("Test Set: {:.3f}".format(forest15.score(X_test, y_test)))

print("")
print("Random Forest accuracy for 25 estinators:")
print("Training Set: {:.3f}".format(forest25.score(X_train, y_train)))
print("Test Set: {:.3f}".format(forest25.score(X_test, y_test)))
